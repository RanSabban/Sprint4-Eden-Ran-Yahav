        ...
        <div style={{ marginLeft: "1em", display: dynClass }}>
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ position: 'absolute', display: dynWorkspace }} className="actions-workspace">
                    <input style={{ position: 'absloute' }} className="input-sidebar" type="search" placeholder="Search for a workspace" autoComplete="off" />
                ...
                <section className="sidebar-workspace">
                    <section style={{ marginBottom: "0" }} className="sidebar-workspace">
                        ...
                        <Tooltip content="Add item to workspace" animationType="expand" ><button className="plus-button"><PlusTool /></button></Tooltip>
                    </section>
                </section>
