...
" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/LionsgateImg.png" alt="" /><img style={{ width: '4.375em' }} className="carrefour-img" src="https://myday-p034.onrender.com/img/home_page/CarrefourImg.png" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/BdImg.png" alt="" /><img style={{ width: '6.875em' }} src="	https://myday-p034.onrender.com/img/home_page/GlossierImg.png" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/UniversalImg.png" alt="" /></div></section>
            ...
            <div className="full-paragraph align-items-left css-1dkjmkt eo3on790" style={{textAlign: 'left'}}><div className="title-wrapper" style={{marginTop: "0px"}}><div className="core-title-container css-18anjwe e168hrcx0"><span className="title-and-icon-wrapper"><div className="icon-wrapper sm"><picture className="picture-component picture-icon-wrapper css-1x9jymf e1ujfqv60"><img alt="board icon" className="title-icon" src="https://dapulse-res.cloudinary.com/image/upload/e_colorize,co_rgb:6161FF/Generator_featured%20images/Home%20Page%20-%202022%20Rebrand/tabs/board_icon.svg"/></picture></div><h2 className="monday-markup-language-component core-title sm" style={{color: "rgb(97, 97, 255)"}}>Boards</h2></span></div></div><div className="paragraph-body-wrapper"><div className="paragraph-wrapper css-1id7hrb ehzaxgp0"><div className="monday-markup-language-component paragraph-body md">Everything starts with a visual board — the core of monday.com Work OS. Tailor it your way and manage anything from projects to departments.</div></div></div></div> */}
        </section >
    )
}