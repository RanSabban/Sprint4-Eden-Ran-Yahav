...
" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/LionsgateImg.png" alt="" /><img style={{ width: '4.375em' }} className="carrefour-img" src="https://myday-p034.onrender.com/img/home_page/CarrefourImg.png" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/BdImg.png" alt="" /><img style={{ width: '6.875em' }} src="	https://myday-p034.onrender.com/img/home_page/GlossierImg.png" alt="" /><img style={{ width: '6.875em' }} src="https://myday-p034.onrender.com/img/home_page/UniversalImg.png" alt="" /></div></section>
            ...
            <div className="full-paragraph align-items-center css-1dkjmkt eo3on790" style={{ textAlign: "center" }}><div className="title-wrapper" style={{ marginTop: "0px" }}><div className="core-title-container css-18anjwe e168hrcx0"><h2 class="monday-markup-language-component core-title lg"><b>Everything you need for any workflow</b></h2></div></div><div class="paragraph-body-wrapper"><div class="paragraph-wrapper css-1id7hrb ehzaxgp0"><div style={{ fontSize: '1.125rem', lineHeight: '32px' }}>Easily build your ideal workflow with monday.com building blocks.</div></div></div></div>
